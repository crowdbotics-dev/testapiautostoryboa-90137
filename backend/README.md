...
## Project Structure
    ...
    ├── testapiautostoryboa_90137  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_90137`
...
2. Clone this repo and `cd testapiautostoryboa_90137`
